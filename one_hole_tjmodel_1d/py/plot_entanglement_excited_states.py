...
ax1.set_title('(a) $t$-$J$, $J=0.3$', fontsize=fs, x=0.3, y=0.9)
...
ax2.set_title('(b) $\sigma\cdot{t}$-$J$, $J=0.3$', fontsize=fs, x=0.35, y=0.9)
...
plt.ylabel('EE', fontsize=fs)
ax3.set_title('(c) $t$-$J$, $J=40.3$', fontsize=fs, x=0.3, y=0.9)
...
plt.xlabel('$E/L$', fontsize=fs)
ax4.set_title('(d) $\sigma\cdot{t}$-$J$, $J=40.3$', fontsize=fs, x=0.35, y=0.9)

image = 'excited_states_EE.pdf'
